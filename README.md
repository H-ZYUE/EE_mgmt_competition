...
- [二、项目分析](#二项目分析)
- [三、实现过程](#三实现过程)
  - [（一）传感器检测及反馈控制](#一传感器检测及反馈控制)
  - [（二）人脸识别考勤](#二人脸识别考勤)
  - [（三）监控分析与记录](#三监控分析与记录)
- [四、电路与程序设计](#四电路与程序设计)
  - [（一）电子模块连接](#一电子模块连接)
  - [（二）程序的设计](#二程序的设计)
    - [（a）Arduino控制方面](#aarduino控制方面)
    - [（b）人脸识别考勤及监控软件方面](#b人脸识别考勤及监控软件方面)
    - [（c）远程监控方面](#c远程监控方面)
    - [（d）违禁品检测方面](#d违禁品检测方面)
- [五、测试方案与测试结果](#五测试方案与测试结果)
  - [（一）测试记录安防情况程序](#一测试记录安防情况程序)
  - [（二）测试违禁品识别程序](#二测试违禁品识别程序)
- [六、参考内容](#六参考内容)
- [附录1：记录安防情况程序的开启](#附录1记录安防情况程序的开启)
- [附录2：传感器方面代码](#附录2传感器方面代码)
